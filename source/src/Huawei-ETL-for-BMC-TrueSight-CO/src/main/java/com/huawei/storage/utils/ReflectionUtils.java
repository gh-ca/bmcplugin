...
public class ReflectionUtils {
    ...
    public static List<StorageObject> invokeRestHandler(StorageObjectType type, DeviceManager deviceManager) throws ETLException {
        ...
        try {
            ...
            Method method = clazz.getDeclaredMethod(methodName, String.class, String.class, PreQuery.class,DeviceManager.class);
            storageObjects = (List<StorageObject>) method.invoke(o, type.getCountCommand(), type.getQueryCommand(), type.getPreQuery(),deviceManager);
